...
namespace Leap.Hololens
{
    ...
    public class LeapServiceProviderV2 : LeapProvider
    {
        ...
        protected bool _useInterpolation = false;//true;
    ...
    protected int BounceAmount = 70;
        ...
        protected LeapWebSocketController leap_controller_;
        ...
        protected virtual void FixedUpdate()
        {
            ...
            {
                transformFrame(_untransformedFixedFrame, _transformedFixedFrame);
                if(_transformedFixedFrame.Id != 0)
