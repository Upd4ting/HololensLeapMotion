...
namespace Leap.Hololens
{
    ...
    public class LeapServiceProvider : LeapProvider
    {
        ...
        [SerializeField]
        protected eLeapDeviceType _overrideDeviceTypeWith = eLeapDeviceType.eLeapDeviceType_Peripheral;
        ...
        protected virtual void Update()
        {
            ...
            _transformedUpdateFrame = _untransformedUpdateFrame;
        ...
        protected virtual void FixedUpdate()
        {
            ...
            _transformedFixedFrame = webController.Frame();
        }
        ...
        protected void updateIfTransformMoved(Frame source, ref Frame toUpdate)
        {
            ...
            if (toUpdate == null)
            {
                ...
                if (false)//_temporalWarping != null)
                {
